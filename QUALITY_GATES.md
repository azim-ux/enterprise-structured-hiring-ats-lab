...
| Desktop print design | The desktop deck declares deterministic print typography and accessible color tokens; rendered text stays at or above 12 points, all extracted text boxes stay within page bounds, and editorial structures replace the earlier pill/card template. The mobile PDF hash is pinned as an invariant. |
